...
export default function Courses({ links }) {
    ...
    const handleSearch = (e) => {
        ...
        if (text === '') {
            ...
            const filtered = otherCourses.filter(
                (c) => c.code.toLowerCase().includes(text) || c.name.toLowerCase().includes(text)
            );
    ...
    return (
        <div
            className='course-wrapper mt-3 mt-md-0'
            style={{
        ...
        >
            ...
            >
                ...
                {registeredCourses && registeredCourses.length > 0 ? (
                        ...
                        (c, i) =>
                            c.code !== '' && (
                                <div key={i}>
                                    ...
                                    >
                                        ...
                                        >
                                            <div className='d-flex justify-content-between'>
                                                ...
                                                >
                                                    ...
                                                    <span>
                                                        <DeleteCourse id={c.id} />
                                                    </span>
                                                </div>
                                            </div>
                                            <div className='d-flex mt-1 justify-content-between align-items-center text-secondary'>
                                                {c.prof && <div className='p'>{c.prof}</div>}
                                                {c.ltp && <div className='p'>L-T-P-C: {c.ltp}</div>}
                                            </div>
                                        </div>
                                        <div
                                        ...
                                        >
                                            <span>
                                                <FontAwesomeIcon
                                                    role={'button'}
                                                    icon={show?.includes(c.code) ? faAngleUp : faAngleDown}
                                                />
                                            </span>
                                        </div>
                                    </li>
                                    ...
                                    <div
                                        className={`${show.includes(c.code) ? 'env-open' : 'env-close'} env bg-dark mx-2`}
                                    >
                                        <div
                                            className='px-3'
                                            style={{
                                        ...
                                        >
                                            <div className='d-flex justify-content-between'>
                                                {c.credit && <div className='p'>Credit: {c.credit}</div>}
                                            </div>
                                            {c.details && <div className='p mt-1'> Details: {c.details}</div>}

                                            <hr className='mt-2' />

                                            <div className='p text-light'>
                                                Useful Links <AddLinks parentId={c.id} />
                                            </div>
                                            {links.filter((link) => link.parentId === c.id).length > 0 ? (
                                                links
                                                    .filter((link) => link.parentId === c.id)
                                                    .map((l) => (
                                                        <span
                                                            key={l.id}
                                                            className='my-1 d-flex justify-content-between links-li '
                                                        >
                                                            <a
                                                                href={l.url}
                                                                rel='noreferrer'
                    ...
                    <div className='text-secondary mt-4 text-center small'>
                        No Courses! <br />
                    </div>
                )}
            </ul>
