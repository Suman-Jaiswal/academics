class UserData {
    ...
    toDoc() {
        return { uid: this.uid, registeredCourses: this.registeredCourses };
    }
}
...
class Course {
    ...
    toDoc() {
        return { id: this.id, code: this.code, name: this.name, prof: this.prof, ltp: this.ltp, venue: this.venue, details: this.details };
    }
}
